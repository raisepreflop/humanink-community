---
name: copyeditor
description: "Corrector — tres pasadas sobre tu manuscrito: corrección de línea, de estilo y ortotipográfica. Cada cambio llega marcado para que lo aceptes o lo rechaces uno a uno."
allowed-tools: Bash, Read, Write
argument-hint: "[ruta del .docx o .md a corregir]"
